...
**Copyright © 2026 Sreekar Bharadwaz. All rights reserved.**

This repository is provided for **research, educational, and reference purposes**.

Unless otherwise stated, the original CAEA source code, documentation, figures, and project materials in this repository may **not** be copied, modified, redistributed, republished, or used for commercial purposes without prior written permission from the author.

No open-source license is granted for the original project materials. In particular, this repository is **not released under the MIT License, Apache License, GPL, or any other open-source license**.

Third-party datasets, libraries, pretrained models, and other external materials remain subject to their respective licenses and terms. This notice does not claim ownership of third-party materials.

For permission to reuse or redistribute CAEA materials, please contact the author.
